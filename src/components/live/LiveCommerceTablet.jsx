...
/**
 * LiveCommerceTablet - 태블릿용 라이브 커머스 뷰
 * - 비디오 영역 (60%) + 우측 사이드 패널 (40%)
 * - 사이드 패널: 상품 목록(위) + 채팅(아래)
 * - 하단 퀵액션바 유지
 */
const LiveCommerceTablet = ({
  // Mini mode
  isMiniMode,
  miniPos,
  miniWidth,
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "relative h-full pointer-events-none transition-all duration-500 flex",
      ...
      >
        ...
        <div className="relative w-[60%] h-full">
          ...
          <div className={cn(
            ...
            {/* Bottom Interaction Sidebar */}
            <div className="absolute bottom-0 left-0 right-0 z-[60] flex flex-col pointer-events-none pb-6">
              <div className="flex items-end justify-end px-6 w-full">
                <LiveInteractionSidebar 
                  ...
                  isLiked={isLiked} 
                  likeCount={likeCount} 
                  onChatExpand={() => {}} // Tablet에서는 사이드바에 채팅이 표시됨
        ...
        {/* Right Column: Product List + Chat (40%) */}
        <div 
          className={cn(
            "w-[40%] h-full bg-zinc-900 border-l border-white/10 flex flex-col overflow-hidden transition-opacity duration-500",
            isMiniMode ? "opacity-0" : "opacity-100 delay-500"
          )}
        >
          {/* Product List (Upper Section - 35%) */}
          <div className="h-[35%] border-b border-white/5">
          ...
          {/* Chat Section (Lower Section - 65%) */}
          <div className="flex-1 flex flex-col">
            <div className="p-4 border-b border-white/5">
              <h3 className="text-white font-black text-lg">실시간 대화</h3>
            </div>
      ...
      <div className={cn(
        ...
        {/* Product List View (Full Screen for Tablet) */}
        <LiveProductListView 
...
export default LiveCommerceTablet;
