  ...
  return (
    <div className="flex flex-col items-center gap-4 sm:gap-5 pointer-events-auto mb-2">
      {isAdmin && (
        <>
          <button 
            ...
            className="w-12 h-12 sm:w-14 sm:h-14 bg-zinc-900 border border-white/20 rounded-full flex items-center justify-center text-brand-pink shadow-2xl active:scale-90 transition-all"
            title="방송 실시간 제어"
          >
            <Settings size={24} sm:size={28} />
          </button>
          <button 
            onClick={onProductSheetOpen} 
            className="w-12 h-12 sm:w-14 sm:h-14 bg-brand-pink rounded-full flex items-center justify-center text-white shadow-xl active:scale-90 transition-all"
            title="상품 송출"
          >
      ...
      <button 
        ...
        className="lg:hidden w-12 h-12 sm:w-14 sm:h-14 bg-white/95 rounded-full flex items-center justify-center text-gray-900 shadow-xl active:scale-90 transition-all"
      >
